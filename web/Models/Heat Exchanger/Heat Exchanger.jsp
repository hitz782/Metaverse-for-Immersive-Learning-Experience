<%--
    Document   : Heat Exchanger
    Created on : 8 May, 2024, 5:18:31 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="Heatexchange" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#Heatexchange" position="-1 1.4 -4.2" rotation="0 270 0" scale="0.2 0.2 0.2"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Heat Exchanger" color="white" position="0.4 2.7 -4.3" rotation="0 -90 0"
