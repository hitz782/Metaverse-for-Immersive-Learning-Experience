<%--
    Document   : Lab Glassware
    Created on : 8 May, 2024, 5:12:32 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="chemistry_glassware" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#chemistry_glassware" position="-1 1.2 -4.2" rotation="0 90 0" scale="0.03 0.03 0.03"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="glassware" color="white" position="0.4 2.2 -4.3" rotation="0 -90 0"
