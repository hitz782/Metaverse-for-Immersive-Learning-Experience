<%--
    Document   : Plant Cell1
    Created on : 8 Apr, 2024, 11:40:04 AM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="plant" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#plant" position="-1.2 1.4 -4" rotation="0 180 0" scale="0.005 0.005 0.005"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Plant Cell" color="white" position="0.5 2 -4" rotation="0 -90 0"
