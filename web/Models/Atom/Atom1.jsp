<%--
    Document   : Atom1.jsp
    Created on : 8 May, 2024, 5:00:48 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="Atom" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#Atom" position="-1 1.4 -4.2" rotation="0 90 0" scale="0.02 0.02 0.02"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Atom" color="white" position="0.4 2.2 -4.3" rotation="0 -90 0"
