<%--
    Document   : benzene1
    Created on : 8 May, 2024, 5:03:26 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="chemistry_benzene" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#chemistry_benzene" position="-1 1.6 -4.2" rotation="0 90 0" scale="1 1 1"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Benzene" color="white" position="0.4 2.2 -4.3" rotation="0 -90 0"
