<%--
    Document   : feedback
    Created on : 28 Mar, 2024, 4:54:09 PM
    Author     : hithe
--%>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="image-container">
                        <img src="../Images/feedback.png " alt="FAQ Image">
                    </div>
                </div>
                <div class="col-4"></div>
                <div class="col-4">
                    <div class="message-container">
                        <div class="message-form">
                            ...
                            <form method="POST" action="<%= application.getContextPath()%>/SubmitFeedbackServlet">
                                ...
                                <input type="hidden" name="isFAQ" value="false"> <!-- Since this is for FAQ, set to true -->
