<%--
    Document   : bridge1
    Created on : 8 Apr, 2024, 12:21:57 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="bridge" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#bridge" position="-1 0.9 -4.2" rotation="0 180 0" scale="0.2 0.2 0.2"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Bridge" color="white" position="0.4 2 -4.3" rotation="0 -90 0"
