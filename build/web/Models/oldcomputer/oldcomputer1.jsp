<%--
    Document   : oldcomputer1
    Created on : 8 Apr, 2024, 12:14:59 PM
    Author     : hithe
--%>
...
<html>
    ...
    <a-scene>
        ...
        <a-assets>
            <a-asset-item id="oldcomputer" src="scene.gltf"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#oldcomputer" position="0.4 2 -4.3" rotation="0 180 0" scale="0.5 0.5 0.5"></a-entity>

        <!-- Text on the plane -->
        <a-text id="clickable-text" value="Old Computer" color="white" position="0.5 2.1 -4" rotation="0 -90 0"
